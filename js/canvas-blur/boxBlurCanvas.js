 ...
 *
 * Source: http://www.quasimondo.com/BoxBlurForCanvas/FastBlurDemo.html
 * Adaptation: https://github.com/nervgh/nervgh.github.io/blob/master/js/canvas-blur/boxBlurCanvas.js
 *
 * Usage: context.boxBlurCanvasRGBA(topX, topY, width, height, radius, iterations);
 * Usage: context.boxBlurCanvasRGB(topX, topY, width, height, radius, iterations);
 */
(function(window, undefined) {
    ...
    // boxBlurCanvasRGBA
    context2D.prototype.boxBlurCanvasRGBA = context2D.prototype.boxBlurCanvasRGBA || function(topX, topY, width, height, radius, iterations) {
        ...
        try {
            try {
                imageData = this.getImageData(topX, topY, width, height);
            } catch(e) {
        ...
        this.putImageData(imageData, topX, topY);
    };


    // boxBlurCanvasRGB
    context2D.prototype.boxBlurCanvasRGB = context2D.prototype.boxBlurCanvasRGB || function(topX, topY, width, height, radius, iterations) {
        if(isNaN(radius) || radius < 1) return;
